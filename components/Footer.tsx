      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-14 pb-[max(2.5rem,env(safe-area-inset-bottom))]">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-8 sm:gap-10 mb-10 sm:mb-12">
          <div className="lg:col-span-2 text-center sm:text-left">
            ...
            <div className="flex items-center justify-center sm:justify-start gap-3 mt-6">
              <a
                href="#"
                aria-label="Facebook"
                className="w-10 h-10 rounded-full border border-white/15 flex items-center justify-center hover:bg-white/10 transition-colors text-white/70 hover:text-white"
              >
          ...
          <div className="text-center sm:text-left">
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><a href="/chat" className="hover:text-white transition-colors">Consultar</a></li>
            </ul>
          </div>
        ...
        <div className="border-t border-white/10 pt-8 space-y-4">
          <p className="text-xs text-white/40 leading-relaxed max-w-3xl">
            Aviso legal: Specterlaws proporciona información orientativa basada en fuentes públicas de legislación costarricense.
            No constituye relación abogado-cliente ni reemplaza el consejo de un profesional colegiado.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-between gap-4 text-xs">
            <p>© {new Date().getFullYear()} Specterlaws. Todos los derechos reservados.</p>
            <p className="text-center text-white/40">
              Specterlaws brinda información orientativa y no constituye asesoría legal formal. Para casos complejos, consulte un abogado colegiado.
            </p>
          </div>
        </div>
      </div>
